...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '云烨', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个自由人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'yunyeblog.asia', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客,程序员,个人主页,自留地', // 网站关键词 英文逗号隔开
